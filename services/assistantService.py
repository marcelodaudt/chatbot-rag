...
def assistant_question(question: str, shortextract: str):
    ...
    try:
        ...
        response = clientOpenAI.chat.completions.create(
            model="gpt-4o-mini",
            messages=[
                {"role": "system", "content": "You are a helpful assistant, which will respond only based on the excerpt (context) sent to you. If the context do not have the answer, say that you don't know."},
